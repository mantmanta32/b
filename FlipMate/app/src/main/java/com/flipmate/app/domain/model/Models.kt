...
data class FlipPlan(val positionId:Long=0,val symbol:String,val currentSide:PositionSide,val currentVolume:BigDecimal,val targetSide:PositionSide,val targetVolume:BigDecimal,val mode:String,val useReverse:Boolean)
